...
真实的生活开销（你填的固定/变动支出）优先扣除，剩下的**可自由支配额**才交给理财法则去分配。
...
| **📚 理财法则库** | 内置 **12 个经典法则**（见下表），按人生阶段动态筛选与推荐 |
...
| **🪜 五步财务画像** | 收入 → 固定支出 → 弹性支出 + 智能分类 → 财务画像 → 三桶分配 |
...
> 备用金目标月数**随法则变化**：4321 / 50-30-20 / 六罐子 / Kakeibo = 3 个月；标普象限 / Coast FIRE = 6 个月。
...
| **Kakeibo 记账法** | 收入级 | 需要50 / 想要30 / 突发15 / 文化5 | 3 个月 |
| **4% 提取法则** | 退休提领 | 年提取≤4% / 本金留存96% | — |
| **Coast FIRE** | 收入级 | 冲刺储蓄50 / 日常50 | 6 个月 |
